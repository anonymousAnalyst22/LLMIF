...
#else
#define HAL_LCD_DEBUG_LINE_1 1//HAL_LCD_SERIAL_DEBUG_ONLY
#define HAL_LCD_DEBUG_LINE_2 2//HAL_LCD_SERIAL_DEBUG_ONLY
#define HAL_LCD_DEBUG_LINE_3 3//HAL_LCD_SERIAL_DEBUG_ONLY
#endif
