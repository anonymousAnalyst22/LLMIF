...
/*
 * @brief   Sends Identify query from the specified endpoint and addr
 */
extern ZStatus_t bdb_SendIdentifyQueryWithAddr(uint8 src_endpoint, uint16 shortAddr, uint8 endpoint );
