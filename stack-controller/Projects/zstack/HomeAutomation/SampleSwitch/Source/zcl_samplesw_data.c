...
const cId_t naive_InClusterList[] = {ZCL_CLUSTER_ID_GEN_BASIC,ZCL_CLUSTER_ID_GEN_IDENTIFY};
#define NAIVE_MAX_INCLUSTERS    ( sizeof( naive_InClusterList ) / sizeof( naive_InClusterList[0] ))
const cId_t naive_OutClusterList[] = {ZCL_CLUSTER_ID_GEN_IDENTIFY};
#define NAIVE_MAX_OUTCLUSTERS   ( sizeof( naive_OutClusterList ) / sizeof( naive_OutClusterList[0] ))

SimpleDescriptionFormat_t zclSampleSw_HASimpleDesc =
{
  SAMPLESW_HA_ENDPOINT,                  //  int Endpoint;
...
SimpleDescriptionFormat_t zclSampleSw_ZLLSimpleDesc =
{
  SAMPLESW_ZLL_ENDPOINT,                  //  int Endpoint;
  ZCL_ZLL_PROFILE_ID,                  //  uint16 AppProfId[2];
  ZCL_HA_DEVICEID_ON_OFF_LIGHT_SWITCH,//  uint16 AppDeviceId[2];
  SAMPLESW_DEVICE_VERSION,            //  int   AppDevVer:4;
  SAMPLESW_FLAGS,                     //  int   AppFlags:4;
  NAIVE_MAX_INCLUSTERS,         //  byte  AppNumInClusters;
  (cId_t *)naive_InClusterList, //  byte *pAppInClusterList;
  NAIVE_MAX_OUTCLUSTERS,        //  byte  AppNumInClusters;
  (cId_t *)naive_OutClusterList //  byte *pAppInClusterList;
};

SimpleDescriptionFormat_t zclSampleSw_GPSimpleDesc =
{
  SAMPLESW_GP_ENDPOINT,                  //  int Endpoint;
  ZCL_GP_PROFILE_ID,                  //  uint16 AppProfId[2];
  ZCL_HA_DEVICEID_ON_OFF_LIGHT_SWITCH,//  uint16 AppDeviceId[2];
  SAMPLESW_DEVICE_VERSION,            //  int   AppDevVer:4;
  SAMPLESW_FLAGS,                     //  int   AppFlags:4;
  NAIVE_MAX_INCLUSTERS,         //  byte  AppNumInClusters;
